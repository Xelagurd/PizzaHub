...
class PizzaOrder(
    ...
    @field:ManyToOne
    var user: xelagurd.resourceserver.dto.User? = null,
    ...
    @field:OneToMany
    var pizzas: MutableList<xelagurd.resourceserver.dto.Pizza> = arrayListOf(),

    var placedAt: Date? = null
) {
    fun addPizza(pizza: xelagurd.resourceserver.dto.Pizza) {
