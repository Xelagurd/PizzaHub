...
class IngredientController(private val ingredientRepository: IngredientRepository) {
    ...
    @GetMapping
    fun allIngredients(): Iterable<xelagurd.resourceserver.dto.Ingredient> {
    ...
    fun saveIngredient(@RequestBody ingredient: xelagurd.resourceserver.dto.Ingredient): xelagurd.resourceserver.dto.Ingredient {
